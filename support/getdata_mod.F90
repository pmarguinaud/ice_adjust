...
& PHLI_HRI_OUT, PHLI_HCF_OUT, LDVERBOSE)
...
ALLOCATE (PSRCS    (NPROMA,1,MAX (KLEV, NFLEVG),NGPBLKS))
ALLOCATE (PCLDFR   (NPROMA,1,MAX (KLEV, NFLEVG),NGPBLKS))

ALLOCATE (PHLC_HRC (NPROMA,1,MAX (KLEV, NFLEVG),NGPBLKS))
ALLOCATE (PHLC_HCF (NPROMA,1,MAX (KLEV, NFLEVG),NGPBLKS))
ALLOCATE (PHLI_HRI (NPROMA,1,MAX (KLEV, NFLEVG),NGPBLKS))
ALLOCATE (PHLI_HCF (NPROMA,1,MAX (KLEV, NFLEVG),NGPBLKS))
