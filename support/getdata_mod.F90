...
ALLOCATE (PSRCS    (NPROMA,1,KLEV,NGPBLKS))
ALLOCATE (PCLDFR   (NPROMA,1,KLEV,NGPBLKS))

ALLOCATE (PHLC_HRC (NPROMA,1,KLEV,NGPBLKS))
ALLOCATE (PHLC_HCF (NPROMA,1,KLEV,NGPBLKS))
ALLOCATE (PHLI_HRI (NPROMA,1,KLEV,NGPBLKS))
ALLOCATE (PHLI_HCF (NPROMA,1,KLEV,NGPBLKS))
