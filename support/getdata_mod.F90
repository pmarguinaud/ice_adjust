...
SUBROUTINE GETDATA (NPROMA, NGPBLKS, NFLEVG, PZZF, PRHODJ, PEXNREF, PRHODREF,       &
& PPABSM, PTHT, PSIGS, PMFCONV, PRC_MF, PRI_MF, PCF_MF, PTHS, PRS, PSRCS, PCLDFR,   &
& PHLC_HRC, PHLC_HCF, PHLI_HRI, PHLI_HCF, ZRS, ZZZ, PRS_OUT, PSRCS_OUT, PCLDFR_OUT, &
